...
/* V2 : modifications du script suite à la modification de la structure de la bd


/* Suite des inserts des ennoncé de compérences de Fabrice : a replacer au bon endroit dans insertCompetences */

/* Un champs "spécifique" à été ajouté dans la table EnonceCompetence*/
...
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (2,'420-JBB-JQ','Programmation et introduction aux objets_EF', 2, 4, 2, NULL, NULL,'Spécifique',NULL,NULL, 1, 1)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (3,'420-JAC-JQ','Informatique et technologie_EF', 3, 3, 2, NULL, NULL,'Spécifique',NULL,NULL, 1, 1)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (4,'420-KCC-JQ','Conception d''interface_EF', 1, 4, 1, NULL, NULL,'Spécifique',NULL,NULL, 1, 1)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (5,'420-KEB-JQ','POO Avancée_EF', 1, 4, 1, NULL, NULL,'Spécifique',NULL,NULL, 1, 1)
GO
...
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (7,'601-101-JQ','Écriture et littérature_EF', 2, 2, 3, NULL, NULL,'Générale',NULL,NULL, 1, 2)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (8,'601-102-JQ','Littérature et inaginaire_EF', 3, 1, 3, NULL, NULL,'Générale',NULL,NULL, 1, 2)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (9,'604-100-MQ','Anglais de base_EF', 2, 1, 3, NULL, NULL,'Générale',NULL,NULL, 1, 2)
GO
INSERT [dbo].[PlanCadre] ([idPlanCadre], [numeroCours], [titreCours], [nbHeureTheorie], [nbHeurePratique], [nbHeureDevoir], [PrealableAbs], [PrealableRel], [indicationPedago], [environnementPhys], [ressource], [idProgramme], [idType]) VALUES (10,'604-100-MQ','Anglais adapté_EF', 2, 1, 3, NULL, NULL,'Générale',NULL,NULL, 1, 2)
GO
