...
GO
INSERT [dbo].[PlanCadreElement] ([idPlanCadreElement], [idPlanCadre], [idElement],[elementsConnaissance]) VALUES (1, 1, 1,N'Vision d’ensemble du monde de l’informatique:'+char(13)+char(10)+'place actuelle de l’informatique dans la socièté;'+char(13)+char(10)+'influences sur les entreprises;'+char(13)+char(10)+'influences sur les gens;'+char(13)+char(10)+'évolution technologique (rappel historique, situation actuelle, tendance).)')
GO
